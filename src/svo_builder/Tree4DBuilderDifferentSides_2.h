#ifndef TREE4DBUILDERDIFFERENTSIDES_2_H
#define TREE4DBUILDERDIFFERENTSIDES_2_H
#include <vector>
#include "Node4D.h"
...
class Tree4DBuilderDifferentSides_2
{
public:
	...
	Tree4DBuilderDifferentSides_2(std::string base_filename, size_t gridsize_S, size_t gridsize_T, bool generate_levels);
...
private:
	...
	int calculateQueueShouldItBePossibleToAddAllVoxelsAtOnce(const size_t nbOfEmptyNodesToAdd);
