#ifndef TRI4D_TOOLS_H_
#define TRI4D_TOOLS_H_
...
inline void readTriangle4D(FILE* f, Triangle4D &t) {
	size_t read = fread(&t, TRIANGLE4D_SIZE*sizeof(float), 1, f);
}

inline void readTriangles4D(FILE* f, Triangle4D &t, size_t howmany) {
	size_t read = fread(&t, TRIANGLE4D_SIZE*sizeof(float), howmany, f);
}

inline void writeTriangle4D(FILE* f, Triangle4D &t) {
	fwrite(&t, TRIANGLE4D_SIZE*sizeof(float), 1, f);
}

inline void writeTriangles4D(FILE* f, Triangle4D &t, size_t howmany) {
